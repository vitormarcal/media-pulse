...
data class Artist(
    ...
    @Column(name = "profile_image_url") val profileImageUrl: String? = null,
    @Column(name = "wikidata_entity_id") val wikidataEntityId: String? = null,
    @Column(name = "wikimedia_file_name") val wikimediaFileName: String? = null,
    @Column(name = "wikimedia_original_url") val wikimediaOriginalUrl: String? = null,
    @Column(name = "wikimedia_description_url") val wikimediaDescriptionUrl: String? = null,
    @Column(name = "wikimedia_author") val wikimediaAuthor: String? = null,
    @Column(name = "wikimedia_license") val wikimediaLicense: String? = null,
    @Column(name = "wikimedia_license_url") val wikimediaLicenseUrl: String? = null,
    @Column(name = "wikimedia_imported_at") val wikimediaImportedAt: Instant? = null,
    @Column(name = "wikimedia_attempted_at") val wikimediaAttemptedAt: Instant? = null,
    @Column(name = "wikimedia_sync_error") val wikimediaSyncError: String? = null,
